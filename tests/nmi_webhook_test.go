...
func TestNMIWebhookPayloads(t *testing.T) {
	t.Run("Load Subscription Add Payload", func(t *testing.T) {
		payload, err := replay.LoadTestWebhookPayload("nmi", "recurring_subscription_add.json")
	...
	t.Run("Load Subscription Update Payload", func(t *testing.T) {
		payload, err := replay.LoadTestWebhookPayload("nmi", "recurring_subscription_update.json")
	...
	t.Run("Load Subscription Delete Payload", func(t *testing.T) {
		payload, err := replay.LoadTestWebhookPayload("nmi", "recurring_subscription_delete.json")
	...
	t.Run("Invalid Payload File", func(t *testing.T) {
		_, err := replay.LoadTestWebhookPayload("nmi", "nonexistent.json")
...
func TestNMIWebhookValidation(t *testing.T) {
	t.Run("Validate Subscription Add Event", func(t *testing.T) {
		err := replay.ValidateEvent("nmi", "recurring_subscription_add.json")
	...
	t.Run("Validate Subscription Update Event", func(t *testing.T) {
		err := replay.ValidateEvent("nmi", "recurring_subscription_update.json")
	...
	t.Run("Validate Subscription Delete Event", func(t *testing.T) {
		err := replay.ValidateEvent("nmi", "recurring_subscription_delete.json")
	...
	t.Run("Validate All NMI Events", func(t *testing.T) {
		err := replay.ValidateAllEvents("nmi")

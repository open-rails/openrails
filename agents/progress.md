...
**Merge note (#474/F overlap):** `RequireBillingCurrency` was added here because it was absent in this base.
If the concurrent F change also adds it, collapse to ONE definition (semantics: reject qualified custom units,
else ValidateCurrency).

...
func testManualRebillPayload() ManualRebillPayload {
	...
	return ManualRebillPayload{
		...
		Instrument:             RebillInstrument{PSPID: uuid.MustParse("12121212-1212-1212-1212-121212121212"), Custodian: models.CustodianPSP, RailCustomerRef: "vault-frozen", RailMethodRef: "billing-frozen"},

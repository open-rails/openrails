...
func TestManualRebillReceiptBindsFrozenOperation(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"vault", func(_ *gen.OpenrailsRailIntent, p *ManualRebillPayload) { p.CustomerVaultID = "other" }},
		...
		{"billing reference", func(_ *gen.OpenrailsRailIntent, p *ManualRebillPayload) { p.BillingID = "other" }},

...
CREATE TABLE openrails.provider_evidence_transactions (
    ...
    CONSTRAINT provider_evidence_transactions_currency_shape CHECK (currency IS NULL OR currency ~ '^[A-Z0-9]{3,12}$'),
...
CREATE TABLE openrails.provider_evidence_subscriptions (
    ...
    CONSTRAINT provider_evidence_subscriptions_currency_shape CHECK (currency IS NULL OR currency ~ '^[A-Z0-9]{3,12}$'),

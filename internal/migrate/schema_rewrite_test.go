...
func TestRewriteMigrationsSchema(t *testing.T) {
	...
	// Real-migration relocation checks for 025/026 were dropped: those incremental
	// files were folded into the consolidated 001 baseline (the 001..029 squash),
	// and the rewrite logic is covered by the synthetic cases above.
}

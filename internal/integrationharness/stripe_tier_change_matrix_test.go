...
// checkStripeTierChangeReplay: a Stripe tier change is one
...
// proven.
func checkStripeTierChangeReplay(t *testing.T, h *Harness, gateway *FakeStripeGateway, d moneyDeployment) {
	t.Helper()

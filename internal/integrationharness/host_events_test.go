...
func TestHostEventsReplayAcrossEmbeddedAndHTTPClients(t *testing.T) {
	...
	remote := server.Client(openrails.WithMerchantID(a.MerchantID), openrails.WithTokenProvider(func(context.Context) (string, error) { return token, nil }))
	...
	other := server.Client(openrails.WithMerchantID(b.MerchantID), openrails.WithTokenProvider(func(context.Context) (string, error) { return otherToken, nil }))
	...
	reader := server.Client(openrails.WithMerchantID(a.MerchantID), openrails.WithTokenProvider(func(context.Context) (string, error) { return readToken, nil }))

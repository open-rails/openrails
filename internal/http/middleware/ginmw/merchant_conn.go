...
// context (ResolveMerchant for single-merchant; ServiceTokenRequired / DelegatedSelfRequired
// for the multi-merchant service/self/merchant-admin groups, which override the
...
// connects as a privileged role (self-hosted single-merchant), RLS is a no-op and

...
// Static authority records isolate this crypto/proof boundary; the companion
// PostgreSQL workflow separately qualifies live AuthKit authority and revocation.

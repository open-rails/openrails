...
func TestGuessBaseURLPortal(t *testing.T) {
	...
	t.Run("prefers origin", func(t *testing.T) {
		req := httptest.NewRequest("GET", "http://openrails.test/v1/me/billing-portal", nil)
	...
	t.Run("uses tls host fallback", func(t *testing.T) {
		req := httptest.NewRequest("GET", "https://openrails.example.com/v1/me/billing-portal", nil)
		req.TLS = &tls.ConnectionState{}
		require.Equal(t, "https://openrails.example.com", guessBaseURLPortal(req))
	})

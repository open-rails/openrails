...
INSERT INTO openrails.entitlements (
    ...
    NULLIF(sqlc.arg(merchant_subject_id)::uuid, '00000000-0000-0000-0000-000000000000'::uuid),
...
-- name: ListEntitlementsByMerchantSubject :many
SELECT * FROM openrails.entitlements ent
WHERE ent.merchant_subject_id = $1
  AND ent.deleted_at IS NULL
ORDER BY ent.start_at DESC;
...
-- name: AttachEntitlementMerchantSubject :exec

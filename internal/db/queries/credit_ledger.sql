...
SELECT * FROM billing.credit_transactions WHERE id = $1 FOR UPDATE;
...
SELECT * FROM billing.credit_windows WHERE id = $1 LIMIT 1;

-- name: GetCreditWindowForUpdate :one
SELECT * FROM billing.credit_windows WHERE id = $1 FOR UPDATE;
...
SELECT * FROM billing.credit_windows

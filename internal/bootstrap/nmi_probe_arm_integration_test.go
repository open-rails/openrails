...
func testModeReconcileConfig() *config.Config {
	return &config.Config{MerchantConfigSource: config.MerchantConfigSourceAPI, SecretBackend: config.SecretBackendDB, TestMode: config.CredentialPostureSandbox}
}
...
func TestReconcileMerchantManifestNMIProbeSkippedOutsideTestMode(t *testing.T) {
	...
	cfg := &config.Config{MerchantConfigSource: config.MerchantConfigSourceAPI, SecretBackend: config.SecretBackendDB, TestMode: config.CredentialPostureLive}

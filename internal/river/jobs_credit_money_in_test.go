...
// When the Charger (and/or CreditsService) is not configured, the money-in
// workers must log-and-skip rather than panic or error, so they are safe to
// register before the rail wiring lands.

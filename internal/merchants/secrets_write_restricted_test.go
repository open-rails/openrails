...
func TestWriteRestrictedSecretStoreBlocksRestrictedPut(t *testing.T) {
	...
	_, err := store.Put(context.Background(), dbtest.TestMerchantID, "solana/private_key", "secret")
	if err == nil {
...
func TestWriteRestrictedSecretStoreAllowsExistingReads(t *testing.T) {
	...
	if _, err := inner.Put(context.Background(), dbtest.TestMerchantID, "solana/private_key", value); err != nil {
	...
	got, err := store.Get(context.Background(), dbtest.TestMerchantID, "solana/private_key")
	if err != nil {

...
var pinnedBoundaries = map[string]string{
	"internal/intents/stripe_engine_receipt.go":              "internal/integrationharness/stripe_engine_signup_test.go",
	"internal/modules/payments/rails/nmidirect/recurring.go": "internal/modules/payments/rails/nmidirect/recurring_test.go",
	...
	// Read-only reference verification compares declared native amounts with
	// exact provider readback; the fixture pins USD/JPY and rejects lost precision.
	"internal/service/catalog_reference_verification.go":      "internal/service/catalog_reference_verification_test.go",

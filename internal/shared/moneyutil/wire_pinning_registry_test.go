...
var deferredBoundaries = map[string]string{
	...
	"internal/modules/money/spend_policy.go":               "settings-only representability validation: discards the converted value and emits no provider request; TestAutoTopupRequiresExactRailAmount covers rejection and the outgoing topup_charge.go amount",

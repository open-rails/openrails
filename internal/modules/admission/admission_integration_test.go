...
func TestAdmit_ThroughputDeny(t *testing.T) {
	...
	req := admission.AdmitRequest{CustomerID: payer, Currency: money.DefaultCurrency, Invoker: "user:a", Tier: "free", Resource: "gpt-4o",
...
func TestAdmit_EndpointGating(t *testing.T) {
	...
	d, err := adm.Admit(ctx, admission.AdmitRequest{CustomerID: payer, Currency: money.DefaultCurrency, Invoker: "user:a", Tier: "free",

...
- Money values (unit "money") in results are decimal strings of integer native units of their currency, not always millionths. Native units per 1 currency unit: %s. State amounts in whole currency units with the currency.

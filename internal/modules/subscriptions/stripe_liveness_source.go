...
// NewStripeLivenessProber builds a prober from the OpenRails config, reusing
...
func NewStripeLivenessProber(cfg *config.Config) (*HTTPStripeLivenessProber, error) {

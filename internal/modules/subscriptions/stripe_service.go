...
func requireStripeRailConfig(rails config.RailSet) (*config.RailConfig, error) {
...
func RequireStripeSecretKey(rails config.RailSet) (*config.RailConfig, string, error) {

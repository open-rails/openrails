...
func TestRailSetShapeValidation(t *testing.T) {
	...
	for name, row := range map[string]struct {
		...
		"ccbill half datalink":        {PSPSet{"ccbill": {Rail: models.RailCCBill, AccountID: "1-2", CCBill: &CCBillRailConfig{DataLinkUsername: "u"}}}, "datalink_username and datalink_password"},

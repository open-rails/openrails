...
4. OpenRails touches the customer `(merchant_id, issuer, delegated_sub)`.
5. `openrails:self:*` or `openrails:merchant:*` permissions decide which route
   families the token can use.

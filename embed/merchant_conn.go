...
func (r *Runtime) runInMerchant(ctx context.Context, fn func(context.Context) error) error {
	if r == nil || r.app == nil || r.app.Runtime == nil {
		return fmt.Errorf("embedded billing: not initialized")
	}
	id := r.app.Runtime.ConfiguredMerchant()
	if id.IsZero() {
	...
	return r.runInMerchantConn(ctx, id, fn)
}
...
func (r *Runtime) runInMerchantConn(ctx context.Context, id merchant.ID, fn func(context.Context) error) error {
	if r == nil || r.app == nil || r.app.Runtime == nil || r.app.Runtime.DB == nil {
		return fmt.Errorf("embedded billing: not initialized")
	}
	if bound := r.app.Runtime.ConfiguredMerchant(); !bound.IsZero() && !id.IsZero() && bound != id {
	...
	return r.app.Runtime.DB.RunInMerchantScope(ctx, id, "embedded merchant work", fn)
}

...
func (c *Client) PreviewProviderCutover(ctx context.Context, subscriptionID string, req ProviderCutoverRequest) (*ProviderCutover, error) {
...
func (c *Client) CutoverProvider(ctx context.Context, subscriptionID string, key string, req ProviderCutoverRequest) (*ProviderCutover, error) {
	var out ProviderCutover
	path, err := subscriptionPath(subscriptionID)
	if err != nil {
		return nil, err
...
func (c *Client) GetProviderCutover(ctx context.Context, subscriptionID string, key string) (*ProviderCutover, error) {
	var out ProviderCutover
	path, err := subscriptionPath(subscriptionID)
	if err != nil {
		return nil, err

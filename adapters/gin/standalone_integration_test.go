...
func TestStandaloneCustomerExposureUnderConsole(t *testing.T) {
	...
	require.NoError(t, runtime.ConfigureHTTP(embed.HTTPConfig{Standalone: true, CustomerExposures: []embed.CustomerHTTPConfig{{Prefix: "/admin/custom", DelegatedAuthenticator: reject}}}))

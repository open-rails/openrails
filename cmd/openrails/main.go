...
func newRootCmd() *cobra.Command {
	...
	rootCmd.AddCommand(serverCmd, workerCmd, migrateCmd, newPushAuthBootstrapCmd(), newPushMerchantConfigCmd(), newDumpMerchantConfigCmd(), newPushCatalogCmd(), newDumpCatalogCmd(), newPullProviderCmd(), newPruneCmd(), newConvergeCmd(), newIntentsCmd(), newIntentsLogCmd(), newLedgerAuditCmd())
	return rootCmd
}

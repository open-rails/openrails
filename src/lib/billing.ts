...
// These territories either do not use postal codes or do not require them for
// ordinary card billing. Keep the value when a customer supplies one, but do
// not block tokenization when the country has no universal postal system.

...
--
-- openrails.manual_rebill_attempts was the durable effectively-once claim table
...
-- now enqueues intent_type='manual_rebill' rows on openrails.provider_intents —
...
DROP TABLE openrails.manual_rebill_attempts;

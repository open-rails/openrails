...
-- is already customer_id). Never a slug/name (#475/#476 convention).
--
...
ALTER TABLE ONLY openrails.budget_policies
    ADD CONSTRAINT budget_policies_customer_fk FOREIGN KEY (customer_id) REFERENCES openrails.customers(id);

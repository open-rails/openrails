...
|---|---|---|
| `test` (default in dev) | sandbox | **Full behavior** — charges, dunning, deletes all run against sandbox processors; no real money can move. Rejected outside `env=development`. |
